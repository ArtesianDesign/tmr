...
<?php $u = new User(); ?>
  ...
  <script src="<?php echo $this->getThemePath(); ?>/_/js/libs/foundation/jquery.foundation.tooltips.js"></script>
  ...
  <script src="<?php echo $this->getThemePath(); ?>/_/js/libs/fancybox/jquery.fancybox.pack.js"></script>
  <?php } ?>
