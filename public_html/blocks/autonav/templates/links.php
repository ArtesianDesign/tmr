...
foreach ($navItems as $ni) {
	...
	$lb = BlockType::getByHandle('login');
	$lb->controller->showRegisterLink = false;
	$lb->controller->returnToSamePage = true;
	...
	?><li class="login-link"><?php echo $output; ?></li><?php
